...
ffi.cdef([[enum{ENET_PROTOCOL_MINIMUM_MTU=0,ENET_PROTOCOL_MAXIMUM_MTU=1,ENET_PROTOCOL_MAXIMUM_PACKET_COMMANDS=2,ENET_PROTOCOL_MINIMUM_WINDOW_SIZE=3,ENET_PROTOCOL_MAXIMUM_WINDOW_SIZE=4,ENET_PROTOCOL_MINIMUM_CHANNEL_COUNT=5,ENET_PROTOCOL_MAXIMUM_CHANNEL_COUNT=6,ENET_PROTOCOL_MAXIMUM_PEER_ID=7,ENET_PROTOCOL_MAXIMUM_FRAGMENT_COUNT=8,
ENET_HOST_RECEIVE_BUFFER_SIZE=0,ENET_HOST_SEND_BUFFER_SIZE=1,ENET_HOST_BANDWIDTH_THROTTLE_INTERVAL=2,ENET_HOST_DEFAULT_MTU=3,ENET_HOST_DEFAULT_MAXIMUM_PACKET_SIZE=4,ENET_HOST_DEFAULT_MAXIMUM_WAITING_DATA=5,ENET_PEER_DEFAULT_ROUND_TRIP_TIME=6,ENET_PEER_DEFAULT_PACKET_THROTTLE=7,ENET_PEER_PACKET_THROTTLE_SCALE=8,ENET_PEER_PACKET_THROTTLE_COUNTER=9,ENET_PEER_PACKET_THROTTLE_ACCELERATION=10,ENET_PEER_PACKET_THROTTLE_DECELERATION=11,ENET_PEER_PACKET_THROTTLE_INTERVAL=12,ENET_PEER_PACKET_LOSS_SCALE=13,ENET_PEER_PACKET_LOSS_INTERVAL=14,ENET_PEER_WINDOW_SIZE_SCALE=15,ENET_PEER_TIMEOUT_LIMIT=16,ENET_PEER_TIMEOUT_MINIMUM=17,ENET_PEER_TIMEOUT_MAXIMUM=18,ENET_PEER_PING_INTERVAL=19,ENET_PEER_UNSEQUENCED_WINDOWS=20,ENET_PEER_UNSEQUENCED_WINDOW_SIZE=21,ENET_PEER_FREE_UNSEQUENCED_WINDOWS=22,ENET_PEER_RELIABLE_WINDOWS=23,ENET_PEER_RELIABLE_WINDOW_SIZE=24,ENET_PEER_FREE_RELIABLE_WINDOWS=25,};typedef enum _ENetProtocolFlag{ENET_PROTOCOL_COMMAND_FLAG_ACKNOWLEDGE=0,ENET_PROTOCOL_COMMAND_FLAG_UNSEQUENCED=1,ENET_PROTOCOL_HEADER_FLAG_COMPRESSED=2,ENET_PROTOCOL_HEADER_FLAG_SENT_TIME=3,ENET_PROTOCOL_HEADER_FLAG_MASK=4,ENET_PROTOCOL_HEADER_SESSION_MASK=5,ENET_PROTOCOL_HEADER_SESSION_SHIFT=6};
typedef enum _ENetSocketWait{ENET_SOCKET_WAIT_NONE=0,ENET_SOCKET_WAIT_SEND=1,ENET_SOCKET_WAIT_RECEIVE=2,ENET_SOCKET_WAIT_INTERRUPT=3};
typedef enum _ENetSocketOption{ENET_SOCKOPT_NONBLOCK=0,ENET_SOCKOPT_BROADCAST=1,ENET_SOCKOPT_RCVBUF=2,ENET_SOCKOPT_SNDBUF=3,ENET_SOCKOPT_REUSEADDR=4,ENET_SOCKOPT_RCVTIMEO=5,ENET_SOCKOPT_SNDTIMEO=6,ENET_SOCKOPT_ERROR=7,ENET_SOCKOPT_NODELAY=8};
...
typedef enum _ENetSocketType{ENET_SOCKET_TYPE_STREAM=0,ENET_SOCKET_TYPE_DATAGRAM=1};
...
typedef enum _ENetPacketFlag{ENET_PACKET_FLAG_RELIABLE=0,ENET_PACKET_FLAG_UNSEQUENCED=1,ENET_PACKET_FLAG_NO_ALLOCATE=2,ENET_PACKET_FLAG_UNRELIABLE_FRAGMENT=3,ENET_PACKET_FLAG_SENT=4};
...
library.e = {
	...
	PROTOCOL_MINIMUM_MTU = 0,
	PROTOCOL_MAXIMUM_MTU = 1,
	PROTOCOL_MAXIMUM_PACKET_COMMANDS = 2,
	PROTOCOL_MINIMUM_WINDOW_SIZE = 3,
	PROTOCOL_MAXIMUM_WINDOW_SIZE = 4,
	PROTOCOL_MINIMUM_CHANNEL_COUNT = 5,
	PROTOCOL_MAXIMUM_CHANNEL_COUNT = 6,
	PROTOCOL_MAXIMUM_PEER_ID = 7,
	PROTOCOL_MAXIMUM_FRAGMENT_COUNT = 8,
	HOST_RECEIVE_BUFFER_SIZE = 0,
	HOST_SEND_BUFFER_SIZE = 1,
	HOST_BANDWIDTH_THROTTLE_INTERVAL = 2,
	HOST_DEFAULT_MTU = 3,
	HOST_DEFAULT_MAXIMUM_PACKET_SIZE = 4,
	HOST_DEFAULT_MAXIMUM_WAITING_DATA = 5,
	PEER_DEFAULT_ROUND_TRIP_TIME = 6,
	PEER_DEFAULT_PACKET_THROTTLE = 7,
	PEER_PACKET_THROTTLE_SCALE = 8,
	PEER_PACKET_THROTTLE_COUNTER = 9,
	PEER_PACKET_THROTTLE_ACCELERATION = 10,
	PEER_PACKET_THROTTLE_DECELERATION = 11,
	PEER_PACKET_THROTTLE_INTERVAL = 12,
	PEER_PACKET_LOSS_SCALE = 13,
	PEER_PACKET_LOSS_INTERVAL = 14,
	PEER_WINDOW_SIZE_SCALE = 15,
	PEER_TIMEOUT_LIMIT = 16,
	PEER_TIMEOUT_MINIMUM = 17,
	PEER_TIMEOUT_MAXIMUM = 18,
	PEER_PING_INTERVAL = 19,
	PEER_UNSEQUENCED_WINDOWS = 20,
	PEER_UNSEQUENCED_WINDOW_SIZE = 21,
	PEER_FREE_UNSEQUENCED_WINDOWS = 22,
	PEER_RELIABLE_WINDOWS = 23,
	PEER_RELIABLE_WINDOW_SIZE = 24,
	PEER_FREE_RELIABLE_WINDOWS = 25,
}
library.clib = CLIB
return library
