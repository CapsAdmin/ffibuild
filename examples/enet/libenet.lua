...
ENET_HOST_RECEIVE_BUFFER_SIZE=262144,ENET_HOST_SEND_BUFFER_SIZE=262144,ENET_HOST_BANDWIDTH_THROTTLE_INTERVAL=1000,ENET_HOST_DEFAULT_MTU=1400,ENET_HOST_DEFAULT_MAXIMUM_PACKET_SIZE=33554432,ENET_HOST_DEFAULT_MAXIMUM_WAITING_DATA=33554432,ENET_PEER_DEFAULT_ROUND_TRIP_TIME=500,ENET_PEER_DEFAULT_PACKET_THROTTLE=32,ENET_PEER_PACKET_THROTTLE_SCALE=32,ENET_PEER_PACKET_THROTTLE_COUNTER=7,ENET_PEER_PACKET_THROTTLE_ACCELERATION=2,ENET_PEER_PACKET_THROTTLE_DECELERATION=2,ENET_PEER_PACKET_THROTTLE_INTERVAL=5000,ENET_PEER_PACKET_LOSS_SCALE=65536,ENET_PEER_PACKET_LOSS_INTERVAL=10000,ENET_PEER_WINDOW_SIZE_SCALE=65536,ENET_PEER_TIMEOUT_LIMIT=32,ENET_PEER_TIMEOUT_MINIMUM=5000,ENET_PEER_TIMEOUT_MAXIMUM=30000,ENET_PEER_PING_INTERVAL=500,ENET_PEER_UNSEQUENCED_WINDOWS=64,ENET_PEER_UNSEQUENCED_WINDOW_SIZE=1024,ENET_PEER_FREE_UNSEQUENCED_WINDOWS=32,ENET_PEER_RELIABLE_WINDOWS=16,ENET_PEER_RELIABLE_WINDOW_SIZE=4096,ENET_PEER_FREE_RELIABLE_WINDOWS=8,};typedef enum _ENetSocketOption{ENET_SOCKOPT_NONBLOCK=1,ENET_SOCKOPT_BROADCAST=2,ENET_SOCKOPT_RCVBUF=3,ENET_SOCKOPT_SNDBUF=4,ENET_SOCKOPT_REUSEADDR=5,ENET_SOCKOPT_RCVTIMEO=6,ENET_SOCKOPT_SNDTIMEO=7,ENET_SOCKOPT_ERROR=8,ENET_SOCKOPT_NODELAY=9};
...
local library = {}
library = {
	host_compress = CLIB.enet_host_compress,
	socket_connect = CLIB.enet_socket_connect,
	peer_disconnect_now = CLIB.enet_peer_disconnect_now,
	list_move = CLIB.enet_list_move,
	address_set_host = CLIB.enet_address_set_host,
	peer_reset = CLIB.enet_peer_reset,
	socket_bind = CLIB.enet_socket_bind,
	time_get = CLIB.enet_time_get,
	socket_accept = CLIB.enet_socket_accept,
	range_coder_compress = CLIB.enet_range_coder_compress,
	socket_create = CLIB.enet_socket_create,
	packet_create = CLIB.enet_packet_create,
	peer_disconnect = CLIB.enet_peer_disconnect,
	address_get_host_ip = CLIB.enet_address_get_host_ip,
	list_remove = CLIB.enet_list_remove,
	socket_receive = CLIB.enet_socket_receive,
	initialize_with_callbacks = CLIB.enet_initialize_with_callbacks,
	socket_send = CLIB.enet_socket_send,
	malloc = CLIB.enet_malloc,
	socket_listen = CLIB.enet_socket_listen,
	peer_timeout = CLIB.enet_peer_timeout,
	list_clear = CLIB.enet_list_clear,
	linked_version = CLIB.enet_linked_version,
	time_set = CLIB.enet_time_set,
	packet_resize = CLIB.enet_packet_resize,
	host_broadcast = CLIB.enet_host_broadcast,
	peer_queue_outgoing_command = CLIB.enet_peer_queue_outgoing_command,
	peer_dispatch_incoming_reliable_commands = CLIB.enet_peer_dispatch_incoming_reliable_commands,
	initialize = CLIB.enet_initialize,
	host_service = CLIB.enet_host_service,
	protocol_command_size = CLIB.enet_protocol_command_size,
	...
	host_check_events = CLIB.enet_host_check_events,
	host_connect = CLIB.enet_host_connect,
	...
	range_coder_decompress = CLIB.enet_range_coder_decompress,
	peer_reset_queues = CLIB.enet_peer_reset_queues,
	host_compress_with_range_coder = CLIB.enet_host_compress_with_range_coder,
	socketset_select = CLIB.enet_socketset_select,
	list_size = CLIB.enet_list_size,
	host_bandwidth_limit = CLIB.enet_host_bandwidth_limit,
	free = CLIB.enet_free,
}
library.e = {
