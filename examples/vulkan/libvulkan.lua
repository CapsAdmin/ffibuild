...
function library.structs.DeviceCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_DEVICE_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkDeviceCreateInfo", tbl) end
function library.structs.SubmitInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_SUBMIT_INFO" tbl.pNext = nil return ffi.new("struct VkSubmitInfo", tbl) end
function library.structs.MemoryAllocateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_INFO" tbl.pNext = nil return ffi.new("struct VkMemoryAllocateInfo", tbl) end
function library.structs.MappedMemoryRange(tbl) tbl.sType = "VK_STRUCTURE_TYPE_MAPPED_MEMORY_RANGE" tbl.pNext = nil return ffi.new("struct VkMappedMemoryRange", tbl) end
function library.structs.BindSparseInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_BIND_SPARSE_INFO" tbl.pNext = nil return ffi.new("struct VkBindSparseInfo", tbl) end
function library.structs.FenceCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_FENCE_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkFenceCreateInfo", tbl) end
function library.structs.SemaphoreCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_SEMAPHORE_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkSemaphoreCreateInfo", tbl) end
function library.structs.EventCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_EVENT_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkEventCreateInfo", tbl) end
function library.structs.QueryPoolCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_QUERY_POOL_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkQueryPoolCreateInfo", tbl) end
function library.structs.BufferCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_BUFFER_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkBufferCreateInfo", tbl) end
function library.structs.BufferViewCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_BUFFER_VIEW_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkBufferViewCreateInfo", tbl) end
function library.structs.ImageCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_IMAGE_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkImageCreateInfo", tbl) end
function library.structs.ImageViewCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_IMAGE_VIEW_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkImageViewCreateInfo", tbl) end
function library.structs.ShaderModuleCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_SHADER_MODULE_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkShaderModuleCreateInfo", tbl) end
function library.structs.PipelineCacheCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_PIPELINE_CACHE_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkPipelineCacheCreateInfo", tbl) end
function library.structs.PipelineShaderStageCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkPipelineShaderStageCreateInfo", tbl) end
function library.structs.PipelineVertexInputStateCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkPipelineVertexInputStateCreateInfo", tbl) end
function library.structs.PipelineInputAssemblyStateCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_PIPELINE_INPUT_ASSEMBLY_STATE_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkPipelineInputAssemblyStateCreateInfo", tbl) end
function library.structs.PipelineTessellationStateCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_PIPELINE_TESSELLATION_STATE_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkPipelineTessellationStateCreateInfo", tbl) end
function library.structs.PipelineViewportStateCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_STATE_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkPipelineViewportStateCreateInfo", tbl) end
function library.structs.PipelineRasterizationStateCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkPipelineRasterizationStateCreateInfo", tbl) end
function library.structs.PipelineMultisampleStateCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_PIPELINE_MULTISAMPLE_STATE_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkPipelineMultisampleStateCreateInfo", tbl) end
function library.structs.PipelineDepthStencilStateCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_PIPELINE_DEPTH_STENCIL_STATE_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkPipelineDepthStencilStateCreateInfo", tbl) end
function library.structs.PipelineColorBlendStateCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_STATE_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkPipelineColorBlendStateCreateInfo", tbl) end
function library.structs.PipelineDynamicStateCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_PIPELINE_DYNAMIC_STATE_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkPipelineDynamicStateCreateInfo", tbl) end
function library.structs.GraphicsPipelineCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_GRAPHICS_PIPELINE_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkGraphicsPipelineCreateInfo", tbl) end
function library.structs.ComputePipelineCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_COMPUTE_PIPELINE_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkComputePipelineCreateInfo", tbl) end
function library.structs.PipelineLayoutCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_PIPELINE_LAYOUT_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkPipelineLayoutCreateInfo", tbl) end
function library.structs.SamplerCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_SAMPLER_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkSamplerCreateInfo", tbl) end
function library.structs.DescriptorSetLayoutCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkDescriptorSetLayoutCreateInfo", tbl) end
function library.structs.DescriptorPoolCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkDescriptorPoolCreateInfo", tbl) end
function library.structs.DescriptorSetAllocateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_DESCRIPTOR_SET_ALLOCATE_INFO" tbl.pNext = nil return ffi.new("struct VkDescriptorSetAllocateInfo", tbl) end
function library.structs.WriteDescriptorSet(tbl) tbl.sType = "VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET" tbl.pNext = nil return ffi.new("struct VkWriteDescriptorSet", tbl) end
function library.structs.CopyDescriptorSet(tbl) tbl.sType = "VK_STRUCTURE_TYPE_COPY_DESCRIPTOR_SET" tbl.pNext = nil return ffi.new("struct VkCopyDescriptorSet", tbl) end
function library.structs.FramebufferCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_FRAMEBUFFER_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkFramebufferCreateInfo", tbl) end
function library.structs.RenderPassCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkRenderPassCreateInfo", tbl) end
function library.structs.CommandPoolCreateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_COMMAND_POOL_CREATE_INFO" tbl.pNext = nil return ffi.new("struct VkCommandPoolCreateInfo", tbl) end
function library.structs.CommandBufferAllocateInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO" tbl.pNext = nil return ffi.new("struct VkCommandBufferAllocateInfo", tbl) end
function library.structs.CommandBufferInheritanceInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_INFO" tbl.pNext = nil return ffi.new("struct VkCommandBufferInheritanceInfo", tbl) end
function library.structs.CommandBufferBeginInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO" tbl.pNext = nil return ffi.new("struct VkCommandBufferBeginInfo", tbl) end
function library.structs.RenderPassBeginInfo(tbl) tbl.sType = "VK_STRUCTURE_TYPE_RENDER_PASS_BEGIN_INFO" tbl.pNext = nil return ffi.new("struct VkRenderPassBeginInfo", tbl) end
function library.structs.BufferMemoryBarrier(tbl) tbl.sType = "VK_STRUCTURE_TYPE_BUFFER_MEMORY_BARRIER" tbl.pNext = nil return ffi.new("struct VkBufferMemoryBarrier", tbl) end
function library.structs.ImageMemoryBarrier(tbl) tbl.sType = "VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER" tbl.pNext = nil return ffi.new("struct VkImageMemoryBarrier", tbl) end
...
function library.CreateShaderModule(device, pCreateInfo, pAllocator)
	if type(pCreateInfo) == "table" then pCreateInfo = library.structs.ShaderModuleCreateInfo(pCreateInfo) end
...
function library.CreateFramebuffer(device, pCreateInfo, pAllocator)
	if type(pCreateInfo) == "table" then pCreateInfo = library.structs.FramebufferCreateInfo(pCreateInfo) end
...
function library.CreateDescriptorPool(device, pCreateInfo, pAllocator)
	if type(pCreateInfo) == "table" then pCreateInfo = library.structs.DescriptorPoolCreateInfo(pCreateInfo) end
...
function library.CreateBuffer(device, pCreateInfo, pAllocator)
	if type(pCreateInfo) == "table" then pCreateInfo = library.structs.BufferCreateInfo(pCreateInfo) end
...
function library.CreateSemaphore(device, pCreateInfo, pAllocator)
	if type(pCreateInfo) == "table" then pCreateInfo = library.structs.SemaphoreCreateInfo(pCreateInfo) end
...
function library.CreatePipelineCache(device, pCreateInfo, pAllocator)
	if type(pCreateInfo) == "table" then pCreateInfo = library.structs.PipelineCacheCreateInfo(pCreateInfo) end
...
function library.CreateImageView(device, pCreateInfo, pAllocator)
	if type(pCreateInfo) == "table" then pCreateInfo = library.structs.ImageViewCreateInfo(pCreateInfo) end
...
function library.CreateDevice(physicalDevice, pCreateInfo, pAllocator)
	if type(pCreateInfo) == "table" then pCreateInfo = library.structs.DeviceCreateInfo(pCreateInfo) end
...
function library.CreateInstance(pCreateInfo, pAllocator)
	if type(pCreateInfo) == "table" then pCreateInfo = library.structs.InstanceCreateInfo(pCreateInfo) end
...
function library.CreateImage(device, pCreateInfo, pAllocator)
	if type(pCreateInfo) == "table" then pCreateInfo = library.structs.ImageCreateInfo(pCreateInfo) end
...
function library.CreateFence(device, pCreateInfo, pAllocator)
	if type(pCreateInfo) == "table" then pCreateInfo = library.structs.FenceCreateInfo(pCreateInfo) end
	local box = ffi.new("struct VkFence_T * [1]")
...
function library.CreateRenderPass(device, pCreateInfo, pAllocator)
	if type(pCreateInfo) == "table" then pCreateInfo = library.structs.RenderPassCreateInfo(pCreateInfo) end
...
function library.CreateQueryPool(device, pCreateInfo, pAllocator)
	if type(pCreateInfo) == "table" then pCreateInfo = library.structs.QueryPoolCreateInfo(pCreateInfo) end
...
function library.CreateSampler(device, pCreateInfo, pAllocator)
	if type(pCreateInfo) == "table" then pCreateInfo = library.structs.SamplerCreateInfo(pCreateInfo) end
...
function library.CreateCommandPool(device, pCreateInfo, pAllocator)
	if type(pCreateInfo) == "table" then pCreateInfo = library.structs.CommandPoolCreateInfo(pCreateInfo) end
...
function library.CreateEvent(device, pCreateInfo, pAllocator)
	if type(pCreateInfo) == "table" then pCreateInfo = library.structs.EventCreateInfo(pCreateInfo) end
	local box = ffi.new("struct VkEvent_T * [1]")
