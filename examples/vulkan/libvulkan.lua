...
typedef enum VkIndirectCommandsTokenTypeNVX{VK_INDIRECT_COMMANDS_TOKEN_PIPELINE_NVX=0,VK_INDIRECT_COMMANDS_TOKEN_DESCRIPTOR_SET_NVX=1,VK_INDIRECT_COMMANDS_TOKEN_INDEX_BUFFER_NVX=2,VK_INDIRECT_COMMANDS_TOKEN_VERTEX_BUFFER_NVX=3,VK_INDIRECT_COMMANDS_TOKEN_PUSH_CONSTANT_NVX=4,VK_INDIRECT_COMMANDS_TOKEN_DRAW_INDEXED_NVX=5,VK_INDIRECT_COMMANDS_TOKEN_DRAW_NVX=6,VK_INDIRECT_COMMANDS_TOKEN_DISPATCH_NVX=7,VK_INDIRECT_COMMANDS_TOKEN_TYPE_BEGIN_RANGE_NVX=0,VK_INDIRECT_COMMANDS_TOKEN_TYPE_END_RANGE_NVX=7,VK_INDIRECT_COMMANDS_TOKEN_TYPE_RANGE_SIZE_NVX=8,VK_INDIRECT_COMMANDS_TOKEN_TYPE_MAX_ENUM_NVX=2147483647};
...
typedef enum VkValidationCheckEXT{VK_VALIDATION_CHECK_ALL_EXT=0,VK_VALIDATION_CHECK_BEGIN_RANGE_EXT=0,VK_VALIDATION_CHECK_END_RANGE_EXT=0,VK_VALIDATION_CHECK_RANGE_SIZE_EXT=1,VK_VALIDATION_CHECK_MAX_ENUM_EXT=2147483647};
...
library.e = {
	...
	OBJECT_ENTRY_DESCRIPTOR_SET_NVX = ffi.cast("enum VkObjectEntryTypeNVX", "VK_OBJECT_ENTRY_DESCRIPTOR_SET_NVX"),
	OBJECT_ENTRY_PIPELINE_NVX = ffi.cast("enum VkObjectEntryTypeNVX", "VK_OBJECT_ENTRY_PIPELINE_NVX"),
	OBJECT_ENTRY_INDEX_BUFFER_NVX = ffi.cast("enum VkObjectEntryTypeNVX", "VK_OBJECT_ENTRY_INDEX_BUFFER_NVX"),
	OBJECT_ENTRY_VERTEX_BUFFER_NVX = ffi.cast("enum VkObjectEntryTypeNVX", "VK_OBJECT_ENTRY_VERTEX_BUFFER_NVX"),
	OBJECT_ENTRY_PUSH_CONSTANT_NVX = ffi.cast("enum VkObjectEntryTypeNVX", "VK_OBJECT_ENTRY_PUSH_CONSTANT_NVX"),
	...
	INDIRECT_COMMANDS_TOKEN_PIPELINE_NVX = ffi.cast("enum VkIndirectCommandsTokenTypeNVX", "VK_INDIRECT_COMMANDS_TOKEN_PIPELINE_NVX"),
	INDIRECT_COMMANDS_TOKEN_DESCRIPTOR_SET_NVX = ffi.cast("enum VkIndirectCommandsTokenTypeNVX", "VK_INDIRECT_COMMANDS_TOKEN_DESCRIPTOR_SET_NVX"),
	INDIRECT_COMMANDS_TOKEN_INDEX_BUFFER_NVX = ffi.cast("enum VkIndirectCommandsTokenTypeNVX", "VK_INDIRECT_COMMANDS_TOKEN_INDEX_BUFFER_NVX"),
	INDIRECT_COMMANDS_TOKEN_VERTEX_BUFFER_NVX = ffi.cast("enum VkIndirectCommandsTokenTypeNVX", "VK_INDIRECT_COMMANDS_TOKEN_VERTEX_BUFFER_NVX"),
	INDIRECT_COMMANDS_TOKEN_PUSH_CONSTANT_NVX = ffi.cast("enum VkIndirectCommandsTokenTypeNVX", "VK_INDIRECT_COMMANDS_TOKEN_PUSH_CONSTANT_NVX"),
	INDIRECT_COMMANDS_TOKEN_DRAW_INDEXED_NVX = ffi.cast("enum VkIndirectCommandsTokenTypeNVX", "VK_INDIRECT_COMMANDS_TOKEN_DRAW_INDEXED_NVX"),
	INDIRECT_COMMANDS_TOKEN_DRAW_NVX = ffi.cast("enum VkIndirectCommandsTokenTypeNVX", "VK_INDIRECT_COMMANDS_TOKEN_DRAW_NVX"),
	INDIRECT_COMMANDS_TOKEN_DISPATCH_NVX = ffi.cast("enum VkIndirectCommandsTokenTypeNVX", "VK_INDIRECT_COMMANDS_TOKEN_DISPATCH_NVX"),
	...
	indirect_commands_token_type = {
		descriptor_set = ffi.cast("enum VkIndirectCommandsTokenTypeNVX", "VK_INDIRECT_COMMANDS_TOKEN_DESCRIPTOR_SET_NVX"),
		type_begin_range = ffi.cast("enum VkIndirectCommandsTokenTypeNVX", "VK_INDIRECT_COMMANDS_TOKEN_TYPE_BEGIN_RANGE_NVX"),
		draw_indexed = ffi.cast("enum VkIndirectCommandsTokenTypeNVX", "VK_INDIRECT_COMMANDS_TOKEN_DRAW_INDEXED_NVX"),
		dispatch = ffi.cast("enum VkIndirectCommandsTokenTypeNVX", "VK_INDIRECT_COMMANDS_TOKEN_DISPATCH_NVX"),
		type_end_range = ffi.cast("enum VkIndirectCommandsTokenTypeNVX", "VK_INDIRECT_COMMANDS_TOKEN_TYPE_END_RANGE_NVX"),
		draw = ffi.cast("enum VkIndirectCommandsTokenTypeNVX", "VK_INDIRECT_COMMANDS_TOKEN_DRAW_NVX"),
		index_buffer = ffi.cast("enum VkIndirectCommandsTokenTypeNVX", "VK_INDIRECT_COMMANDS_TOKEN_INDEX_BUFFER_NVX"),
		vertex_buffer = ffi.cast("enum VkIndirectCommandsTokenTypeNVX", "VK_INDIRECT_COMMANDS_TOKEN_VERTEX_BUFFER_NVX"),
		push_constant = ffi.cast("enum VkIndirectCommandsTokenTypeNVX", "VK_INDIRECT_COMMANDS_TOKEN_PUSH_CONSTANT_NVX"),
		pipeline = ffi.cast("enum VkIndirectCommandsTokenTypeNVX", "VK_INDIRECT_COMMANDS_TOKEN_PIPELINE_NVX"),
	...
	object_entry_type = {
		...
		iptor_set = ffi.cast("enum VkObjectEntryTypeNVX", "VK_OBJECT_ENTRY_DESCRIPTOR_SET_NVX"),
		x_buffer = ffi.cast("enum VkObjectEntryTypeNVX", "VK_OBJECT_ENTRY_VERTEX_BUFFER_NVX"),
		_buffer = ffi.cast("enum VkObjectEntryTypeNVX", "VK_OBJECT_ENTRY_INDEX_BUFFER_NVX"),
		ine = ffi.cast("enum VkObjectEntryTypeNVX", "VK_OBJECT_ENTRY_PIPELINE_NVX"),
		begin_range = ffi.cast("enum VkObjectEntryTypeNVX", "VK_OBJECT_ENTRY_TYPE_BEGIN_RANGE_NVX"),
		constant = ffi.cast("enum VkObjectEntryTypeNVX", "VK_OBJECT_ENTRY_PUSH_CONSTANT_NVX"),
	...
	structure_type = {
		...
		external_memory_image_create_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO_NV"),
		...
		win32_keyed_mutex_acquire_release_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_NV"),
		export_memory_win32_handle_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_EXPORT_MEMORY_WIN32_HANDLE_INFO_NV"),
		...
		import_memory_win32_handle_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_IMPORT_MEMORY_WIN32_HANDLE_INFO_NV"),
		win32_surface_create_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_WIN32_SURFACE_CREATE_INFO_KHR"),
		export_memory_allocate_info = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO_NV"),
