...
library.e = {
	...
	STRUCTURE_TYPE_DEBUG_REPORT_CREATE_INFO_EXT = ffi.cast("enum VkStructureType", "VK_STRUCTURE_TYPE_DEBUG_REPORT_CREATE_INFO_EXT"),
...
function library.s.DebugReportCallbackCreateInfoEXTArray(tbl) return ffi.new("struct VkDebugReportCallbackCreateInfoEXT[?]", #tbl, tbl) end
function library.s.DebugReportCallbackCreateInfoEXT(tbl) return ffi.new("struct VkDebugReportCallbackCreateInfoEXT", tbl) end
