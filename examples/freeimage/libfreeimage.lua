...
void FreeImage_SetOutputMessageStdCall(void(*)(enum FREE_IMAGE_FORMAT,const char*));
...
void FreeImage_SetOutputMessage(void(*)(enum FREE_IMAGE_FORMAT,const char*));
...
enum FREE_IMAGE_FORMAT FreeImage_RegisterLocalPlugin(void(*)(struct Plugin*,int),const char*,const char*,const char*,const char*);
