...
ffi.cdef([[typedef enum FREE_IMAGE_FORMAT{FIF_UNKNOWN=0,FIF_BMP=1,FIF_ICO=2,FIF_JPEG=3,FIF_JNG=4,FIF_KOALA=5,FIF_LBM=6,FIF_IFF=7,FIF_MNG=8,FIF_PBM=9,FIF_PBMRAW=10,FIF_PCD=11,FIF_PCX=12,FIF_PGM=13,FIF_PGMRAW=14,FIF_PNG=15,FIF_PPM=16,FIF_PPMRAW=17,FIF_RAS=18,FIF_TARGA=19,FIF_TIFF=20,FIF_WBMP=21,FIF_PSD=22,FIF_CUT=23,FIF_XBM=24,FIF_XPM=25,FIF_DDS=26,FIF_GIF=27,FIF_HDR=28,FIF_FAXG3=29,FIF_SGI=30,FIF_EXR=31,FIF_J2K=32,FIF_JP2=33,FIF_PFM=34,FIF_PICT=35,FIF_RAW=36,FIF_WEBP=37,FIF_JXR=38};
typedef enum FREE_IMAGE_MDTYPE{FIDT_NOTYPE=0,FIDT_BYTE=1,FIDT_ASCII=2,FIDT_SHORT=3,FIDT_LONG=4,FIDT_RATIONAL=5,FIDT_SBYTE=6,FIDT_UNDEFINED=7,FIDT_SSHORT=8,FIDT_SLONG=9,FIDT_SRATIONAL=10,FIDT_FLOAT=11,FIDT_DOUBLE=12,FIDT_IFD=13,FIDT_PALETTE=14,FIDT_LONG8=15,FIDT_SLONG8=16,FIDT_IFD8=17};
...
typedef enum FREE_IMAGE_MDMODEL{FIMD_NODATA=0,FIMD_COMMENTS=1,FIMD_EXIF_MAIN=2,FIMD_EXIF_EXIF=3,FIMD_EXIF_GPS=4,FIMD_EXIF_MAKERNOTE=5,FIMD_EXIF_INTEROP=6,FIMD_IPTC=7,FIMD_XMP=8,FIMD_GEOTIFF=9,FIMD_ANIMATION=10,FIMD_CUSTOM=11,FIMD_EXIF_RAW=12};
