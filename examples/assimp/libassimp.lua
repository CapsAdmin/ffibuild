...
typedef enum aiComponent{aiComponent_NORMALS=0,aiComponent_TANGENTS_AND_BITANGENTS=1,aiComponent_COLORS=2,aiComponent_TEXCOORDS=3,aiComponent_BONEWEIGHTS=4,aiComponent_ANIMATIONS=5,aiComponent_TEXTURES=6,aiComponent_LIGHTS=7,aiComponent_CAMERAS=8,aiComponent_MESHES=9,aiComponent_MATERIALS=10};
...
typedef enum aiShadingMode{aiShadingMode_Flat=0,aiShadingMode_Gouraud=1,aiShadingMode_Phong=2,aiShadingMode_Blinn=3,aiShadingMode_Toon=4,aiShadingMode_OrenNayar=5,aiShadingMode_Minnaert=6,aiShadingMode_CookTorrance=7,aiShadingMode_NoShading=8,aiShadingMode_Fresnel=9};
...
typedef enum aiPostProcessSteps{aiProcess_CalcTangentSpace=0,aiProcess_JoinIdenticalVertices=1,aiProcess_MakeLeftHanded=2,aiProcess_Triangulate=3,aiProcess_RemoveComponent=4,aiProcess_GenNormals=5,aiProcess_GenSmoothNormals=6,aiProcess_SplitLargeMeshes=7,aiProcess_PreTransformVertices=8,aiProcess_LimitBoneWeights=9,aiProcess_ValidateDataStructure=10,aiProcess_ImproveCacheLocality=11,aiProcess_RemoveRedundantMaterials=12,aiProcess_FixInfacingNormals=13,aiProcess_SortByPType=14,aiProcess_FindDegenerates=15,aiProcess_FindInvalidData=16,aiProcess_GenUVCoords=17,aiProcess_TransformUVCoords=18,aiProcess_FindInstances=19,aiProcess_OptimizeMeshes=20,aiProcess_OptimizeGraph=21,aiProcess_FlipUVs=22,aiProcess_FlipWindingOrder=23,aiProcess_SplitByBoneCount=24,aiProcess_Debone=25};
typedef enum aiPrimitiveType{aiPrimitiveType_POINT=0,aiPrimitiveType_LINE=1,aiPrimitiveType_TRIANGLE=2,aiPrimitiveType_POLYGON=3};
typedef enum aiBlendMode{aiBlendMode_Default=0,aiBlendMode_Additive=1};
typedef enum aiGrrr{aiProcess_ConvertToLeftHanded=0,aiProcessPreset_TargetRealtime_Fast=1,aiProcessPreset_TargetRealtime_Quality=2,aiProcessPreset_TargetRealtime_MaxQuality=3};
typedef enum aiTextureFlags{aiTextureFlags_Invert=0,aiTextureFlags_UseAlpha=1,aiTextureFlags_IgnoreAlpha=2};
...
typedef enum aiTextureMapMode{aiTextureMapMode_Wrap=0,aiTextureMapMode_Clamp=1,aiTextureMapMode_Decal=2,aiTextureMapMode_Mirror=3};
typedef enum aiPropertyTypeInfo{aiPTI_Float=0,aiPTI_String=1,aiPTI_Integer=2,aiPTI_Buffer=3};
typedef enum aiMetadataType{aiBOOL=0,aiINT=1,aiUINT64=2,aiFLOAT=3,aiAISTRING=4,aiAIVECTOR3D=5};
typedef enum aiDefaultLogStream{aiDefaultLogStream_FILE=0,aiDefaultLogStream_STDOUT=1,aiDefaultLogStream_STDERR=2,aiDefaultLogStream_DEBUGGER=3};
...
typedef enum aiImporterFlags{aiImporterFlags_SupportTextFlavour=0,aiImporterFlags_SupportBinaryFlavour=1,aiImporterFlags_SupportCompressedFlavour=2,aiImporterFlags_LimitedSupport=3,aiImporterFlags_Experimental=4};
typedef enum aiReturn{aiReturn_SUCCESS=0,aiReturn_FAILURE=1,aiReturn_OUTOFMEMORY=2};
