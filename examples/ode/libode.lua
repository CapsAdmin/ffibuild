...
void(dJointGetHinge2Anchor)(struct dxJoint*,float);
void(dPlaneSpace)(const float,float,float);
...
void(dJointGetPRAnchor)(struct dxJoint*,float);
...
int(dBoxBox)(const float,const float,const float,const float,const float,const float,float,float*,int*,int,struct dContactGeom*,int);
...
void(dJointGetTransmissionAnchor2)(struct dxJoint*,float);
int(dBodyGetGyroscopicMode)(struct dxBody*);
void(dJointSetDBallDistance)(struct dxJoint*,float);
void(dBodyGetFiniteRotationAxis)(struct dxBody*,float);
...
void(dJointGetTransmissionAxis)(struct dxJoint*,float);
...
void(dBodySetRotation)(struct dxBody*,const float);
...
void(dJointGetPUAxis3)(struct dxJoint*,float);
void(dCloseODE)();
...
void(dQMultiply1)(float,const float,const float);
void(dBodyAddRelForce)(struct dxBody*,float,float,float);
struct dxBody*(dGeomGetBody)(struct dxGeom*);
void(dGeomGetRelPointPos)(struct dxGeom*,float,float,float,float);
...
void(dRFromAxisAndAngle)(float,float,float,float,float);
...
unsigned long(dRand)();
int(dBoxTouchesBox)(const float,const float,const float,const float,const float,const float);
void(dQfromR)(float,const float);
void(dMassSetParameters)(struct dMass*,float,float,float,float,float,float,float,float,float,float);
void(dDQfromW)(float,const float,const float);
float(dGeomSphereGetRadius)(struct dxGeom*);
void(dGeomSetRotation)(struct dxGeom*,const float);
float(dRandReal)();
void(dBodyGetRelPointPos)(struct dxBody*,float,float,float,float);
int(dWorldGetAutoDisableFlag)(struct dxWorld*);
void(dSolveLDLT)(const float*,const float*,float*,int,int);
void(dJointGetTransmissionAxis1)(struct dxJoint*,float);
...
void(dJointGetUniversalAxis2)(struct dxJoint*,float);
...
void(dJointGetUniversalAnchor)(struct dxJoint*,float);
...
void(dBodyGetRelPointVel)(struct dxBody*,float,float,float,float);
...
void(dJointGetDHingeAxis)(struct dxJoint*,float);
void(dGeomTriMeshDataGetBuffer)(struct dxTriMeshData*,unsigned char**,int*);
void(dJointGetUniversalAxis1)(struct dxJoint*,float);
...
void(dJointGetHinge2Anchor2)(struct dxJoint*,float);
...
void(dJointGetLMotorAxis)(struct dxJoint*,int,float);
...
void(dBodyVectorFromWorld)(struct dxBody*,float,float,float,float);
...
void(dGeomRayGet)(struct dxGeom*,float,float);
...
void(dBodyGetPosRelPoint)(struct dxBody*,float,float,float,float);
void(dJointSetAMotorAngle)(struct dxJoint*,int,float);
void(dGeomGetQuaternion)(struct dxGeom*,float);
...
void(dJointGetBallAnchor2)(struct dxJoint*,float);
...
void(dGeomSetQuaternion)(struct dxGeom*,const float);
void(dJointGetDBallAnchor1)(struct dxJoint*,float);
void(dJointGetDBallAnchor2)(struct dxJoint*,float);
void*(dGeomGetClassData)(struct dxGeom*);
void(dNormalize3)(float);
void(dClosestLineSegmentPoints)(const float,const float,const float,const float,float,float);
void(dJointGetSliderAxis)(struct dxJoint*,float);
...
void(dGeomTriMeshGetTriangle)(struct dxGeom*,int,float*,float*,float*);
...
void(dJointGetPRAxis1)(struct dxJoint*,float);
void(dJointGetTransmissionAnchor1)(struct dxJoint*,float);
...
void(dRFromZAxis)(float,float,float,float);
void(dBodySetData)(struct dxBody*,void*);
void(dGeomTriMeshSetLastTransform)(struct dxGeom*,float);
...
void(dGeomPlaneGetParams)(struct dxGeom*,float);
...
void(dGeomBoxGetLengths)(struct dxGeom*,float);
...
void(dGeomCopyOffsetRotation)(struct dxGeom*,float);
const float*(dGeomGetOffsetRotation)(struct dxGeom*);
void(dGeomCopyOffsetPosition)(struct dxGeom*,float);
...
void(dGeomSetOffsetWorldQuaternion)(struct dxGeom*,const float);
void(dGeomSetOffsetWorldRotation)(struct dxGeom*,const float);
void(dGeomSetOffsetQuaternion)(struct dxGeom*,const float);
void(dGeomSetOffsetRotation)(struct dxGeom*,const float);
...
void(dGeomVectorToWorld)(struct dxGeom*,float,float,float,float);
void(dGeomGetPosRelPoint)(struct dxGeom*,float,float,float,float);
...
void(dJointGetPistonAnchor)(struct dxJoint*,float);
...
void(dGeomGetOffsetQuaternion)(struct dxGeom*,float);
...
void(dJointGetDHingeAnchor1)(struct dxJoint*,float);
...
void(dInitODE)();
void(dBodyCopyQuaternion)(struct dxBody*,float);
...
void(dJointGetPistonAnchor2)(struct dxJoint*,float);
...
void(dBodyCopyPosition)(struct dxBody*,float);
...
void(dJointGetTransmissionAxis2)(struct dxJoint*,float);
...
void(dJointGetTransmissionContactPoint2)(struct dxJoint*,float);
void(dJointSetPUAxisP)(struct dxJoint*,float,float,float);
void(dJointGetTransmissionContactPoint1)(struct dxJoint*,float);
int(dGeomIsOffset)(struct dxGeom*);
struct dxGeom*(dCreateGeom)(int);
void(dJointGetAMotorAxis)(struct dxJoint*,int,float);
float(dJointGetPistonParam)(struct dxJoint*,int);
int(dWorldQuickStep)(struct dxWorld*,float);
void(dJointGetPistonAxis)(struct dxJoint*,float);
void(dJointSetTransmissionBacklash)(struct dxJoint*,float);
void(dGeomCopyPosition)(struct dxGeom*,float);
...
void(dWorldGetGravity)(struct dxWorld*,float);
void(dJointGetPUAxis2)(struct dxJoint*,float);
void(dJointGetPUAxis1)(struct dxJoint*,float);
...
void(dJointGetPUAnchor)(struct dxJoint*,float);
...
void(dJointGetDHingeAnchor2)(struct dxJoint*,float);
float(dJointGetUniversalAngle1)(struct dxJoint*);
float(dJointGetTransmissionAngle2)(struct dxJoint*);
void(dJointGetUniversalAnchor2)(struct dxJoint*,float);
...
void(dJointGetHinge2Axis2)(struct dxJoint*,float);
void(dJointGetHinge2Axis1)(struct dxJoint*,float);
...
void(dJointGetHingeAnchor2)(struct dxJoint*,float);
void(dJointGetHingeAnchor)(struct dxJoint*,float);
void(dJointGetBallAnchor)(struct dxJoint*,float);
...
void(dGeomVectorFromWorld)(struct dxGeom*,float,float,float,float);
...
void(dWorldImpulseToForce)(struct dxWorld*,float,float,float,float,float);
unsigned long(dRandGetSeed)();
void(dRFrom2Axes)(float,float,float,float,float,float,float);
...
void(dJointGetHingeAxis)(struct dxJoint*,float);
void(dRFromEulerAngles)(float,float,float,float);
...
void(dRfromQ)(float,const float);
...
int(dSafeNormalize3)(float);
void(dBodyGetPointVel)(struct dxBody*,float,float,float,float);
void(dJointSetUniversalAnchor)(struct dxJoint*,float,float,float);
void(dError)(int,const char*,...);
void(dJointGetPUAxisP)(struct dxJoint*,float);
int(dTestRand)();
...
void(dBodySetQuaternion)(struct dxBody*,const float);
...
struct dxSpace*(dQuadTreeSpaceCreate)(struct dxSpace*,const float,const float,int);
...
void(dTimerEnd)();
void(dQMultiply0)(float,const float,const float);
...
void(dQFromAxisAndAngle)(float,float,float,float,float);
...
void(dBodyVectorToWorld)(struct dxBody*,float,float,float,float);
...
void(dQMultiply3)(float,const float,const float);
