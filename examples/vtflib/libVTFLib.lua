...
typedef enum tagVTFImageFlag{TEXTUREFLAGS_POINTSAMPLE=0,TEXTUREFLAGS_TRILINEAR=1,TEXTUREFLAGS_CLAMPS=2,TEXTUREFLAGS_CLAMPT=3,TEXTUREFLAGS_ANISOTROPIC=4,TEXTUREFLAGS_HINT_DXT5=5,TEXTUREFLAGS_SRGB=6,TEXTUREFLAGS_DEPRECATED_NOCOMPRESS=7,TEXTUREFLAGS_NORMAL=8,TEXTUREFLAGS_NOMIP=9,TEXTUREFLAGS_NOLOD=10,TEXTUREFLAGS_MINMIP=11,TEXTUREFLAGS_PROCEDURAL=12,TEXTUREFLAGS_ONEBITALPHA=13,TEXTUREFLAGS_EIGHTBITALPHA=14,TEXTUREFLAGS_ENVMAP=15,TEXTUREFLAGS_RENDERTARGET=16,TEXTUREFLAGS_DEPTHRENDERTARGET=17,TEXTUREFLAGS_NODEBUGOVERRIDE=18,TEXTUREFLAGS_SINGLECOPY=19,TEXTUREFLAGS_UNUSED0=20,TEXTUREFLAGS_DEPRECATED_ONEOVERMIPLEVELINALPHA=21,TEXTUREFLAGS_UNUSED1=22,TEXTUREFLAGS_DEPRECATED_PREMULTCOLORBYONEOVERMIPLEVEL=23,TEXTUREFLAGS_UNUSED2=24,TEXTUREFLAGS_DEPRECATED_NORMALTODUDV=25,TEXTUREFLAGS_UNUSED3=26,TEXTUREFLAGS_DEPRECATED_ALPHATESTMIPGENERATION=27,TEXTUREFLAGS_NODEPTHBUFFER=28,TEXTUREFLAGS_UNUSED4=29,TEXTUREFLAGS_DEPRECATED_NICEFILTERED=30,TEXTUREFLAGS_CLAMPU=31,TEXTUREFLAGS_VERTEXTEXTURE=32,TEXTUREFLAGS_SSBUMP=33,TEXTUREFLAGS_UNUSED5=34,TEXTUREFLAGS_DEPRECATED_UNFILTERABLE_OK=35,TEXTUREFLAGS_BORDER=36,TEXTUREFLAGS_DEPRECATED_SPECVAR_RED=37,TEXTUREFLAGS_DEPRECATED_SPECVAR_ALPHA=38,TEXTUREFLAGS_LAST=39,TEXTUREFLAGS_COUNT=40};
typedef enum idtype_t{P_ALL=0,P_PID=1,P_PGID=2};
typedef enum _LIB_VERSION_TYPE{_IEEE_=0,_SVID_=1,_XOPEN_=2,_POSIX_=3,_ISOC_=4};
...
typedef enum tagVTFResourceEntryTypeFlag{RSRCF_HAS_NO_DATA_CHUNK=0};
...
typedef enum tagVTFResourceEntryType{VTF_LEGACY_RSRC_LOW_RES_IMAGE=0,VTF_LEGACY_RSRC_IMAGE=1,VTF_RSRC_SHEET=2,VTF_RSRC_CRC=3,VTF_RSRC_TEXTURE_LOD_SETTINGS=4,VTF_RSRC_TEXTURE_SETTINGS_EX=5,VTF_RSRC_KEY_VALUE_DATA=6,VTF_RSRC_MAX_DICTIONARY_ENTRIES=7};
